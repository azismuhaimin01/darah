...
<head>
  ...
  <title>Dewi Permata Trans | Tentang Kami</title>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="section-title">
          ...
          <h2>MISI</h2>
            <p>Memberikan layanan pariwisata terbaik dengan harga terjangkau</p>
            <p>Menyediakan armada bus dengan fasilitas yang terjaga sangat baik</p>
          <h2>MOTO</h2>
            <p>Desahan anda adalah kepuasan saya</p>
        </div>
      </div>
